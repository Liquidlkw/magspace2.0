...
public class Chess1chooseangle extends View{
    Path path,anopath;
    Paint paint;
...
//    Path shadowpath;
    ...
    public static Chess1chooseangle instance;
    public static  Chess1chooseangle getInstance(Context context, Display display){
        if (instance == null) {
            instance=new Chess1chooseangle(context, display);
        }
        return instance;
    }
    public Chess1chooseangle(Context context) {
        super(context);
    }
    public Chess1chooseangle(Context context,Display display) {
        super(context);
        this.init(display);
    }
    public void init(Display display) {
        ...
        rightcheckanimator = ObjectAnimator.ofFloat(Chess1chooseangle.this, "rightcheckprogress", 0.0f, 1.0f);
        rightcheckanimator.setDuration(750);
        checkanimator = ObjectAnimator.ofFloat(Chess1chooseangle.this, "checkprogress", 0.0f, 1.0f);
        checkanimator.setDuration(750);
        shadowanimator = ObjectAnimator.ofFloat(Chess1chooseangle.this, "shadowprogress", 0.0f, 1.0f);
...
//        this.setBackgroundColor(Color.WHITE);
        ...
        regions[0].typename="540°";
        regions[1].typename="720°";
        regions[2].typename="108°";
        regions[3].typename="120°";
     ;
        namelist[0]="规则多边形";
        namelist[4]="三角形个数";
        namelist[5]="        2";
        ...
        namelist[7]="        4";
        namelist[8]="所有内角和";
        namelist[9]="180°x2=360°";
        namelist[10]="180°x3=540°";
        namelist[11]="180°x3=720°";
        namelist[12]="一个内角";
        namelist[13]="360°÷3=120°";
        namelist[14]="540°÷5=108°";
        namelist[15]="760°÷6=120°";
        //四个数字选择区域
        ...
        chooseregions[0].typename="108°";
        chooseregions[1].typename="120°";
        chooseregions[2].typename="540°";
        chooseregions[3].typename="720°";
    }
...
//       shadowpaint.setPathEffect(createPathEffect(shadowlength, shadowprogress, 0.0f));
    ...
    Bitmap c1 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section3_page1_img1)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section3_page1_img1)).getBitmap() : null;
    Bitmap c2 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section3_page1_img2)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section3_page1_img2)).getBitmap() : null;
    Bitmap c3 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section3_page1_img3)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section3_page1_img3)).getBitmap() : null;
    ;
    public void onDraw(Canvas c) {
        ...
        for(int i=0;i<rects.length;i++){
            ...
            if(i!=1&&i!=2&&i!=3) {
                if(i==10&&!regions[0].isright) { }
               else if(i==11&&!regions[1].isright) { }
                else if(i==14&&!regions[2].isright) { }
               else if(i==15&&!regions[3].isright) { }
                else{
                    c.drawText(namelist[i], pxlist[i] - 9 * onep_screen_w, pylist[i] + onep_screen_h, paint);
                }
            }
        }
        //选择区域
