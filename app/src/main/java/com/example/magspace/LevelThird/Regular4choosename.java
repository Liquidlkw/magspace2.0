...
public class Regular4choosename extends View{
    Path path,anopath;
    Paint paint;
...
//    Path shadowpath;
    ...
    public static Regular4choosename instance;
    public static  Regular4choosename getInstance(Context context, Display display){
        if (instance == null) {
            instance=new Regular4choosename(context, display);
        }
        return instance;
    }
    public Regular4choosename(Context context) {
        super(context);
    }
    public Regular4choosename(Context context,Display display) {
        super(context);
        this.init(display);
    }
    public void init(Display display) {
        ...
        rightcheckanimator = ObjectAnimator.ofFloat(Regular4choosename.this, "rightcheckprogress", 0.0f, 1.0f);
        rightcheckanimator.setDuration(750);
        checkanimator = ObjectAnimator.ofFloat(Regular4choosename.this, "checkprogress", 0.0f, 1.0f);
        checkanimator.setDuration(750);
        shadowanimator = ObjectAnimator.ofFloat(Regular4choosename.this, "shadowprogress", 0.0f, 1.0f);
...
//        this.setBackgroundColor(Color.WHITE);
        ...
        //5个判断区域
        rects= new RectF[5];
        minrects=new RectF[5];
        regions= new Touchregion[5];
        for(int i=0;i<5;i++){
            rects[i]=new RectF((5+30*(i%3))*onep_screen_w,(10+20*(i/3))*onep_screen_h,
                    (25+30*(i%3))*onep_screen_w,(10+20*(i/3))*onep_screen_h+20*onep_screen_w);
            minrects[i]=new RectF((5+30*(i%3))*onep_screen_w,(25+20*(i/3))*onep_screen_h,
                    (25+30*(i%3))*onep_screen_w,(25+20*(i/3))*onep_screen_h+6*onep_screen_w);
        }
        for(int i=0;i<5;i++){
            path = new Path();
            ...
            regions[i].point_y=(int)((25+20*(i/3))*onep_screen_h+3*onep_screen_w);
        }
        regions[0].typename="   正四面体";
        regions[1].typename="   正八面体";
        regions[2].typename="正二十面体";
        regions[3].typename="     立方体";
        regions[4].typename="正十二面体";
        //5个数字选择区域
        chooserectfs= new RectF[5];
        for(int i=0;i<5;i++){
            chooserectfs[i]=new RectF((16*i+5)*onep_screen_w,60*onep_screen_h-5*onep_screen_w,
                    (16*i+15)*onep_screen_w,60*onep_screen_h+5*onep_screen_w);
        ...
        for(int i=0;i<5;i++){
            ...
            chooseregions[i].point_x=(int)((16*i+10)*onep_screen_w);
            chooseregions[i].point_y=(int)(60*onep_screen_h);
        }
        chooseregions[0].typename="   正四面体";
        chooseregions[1].typename="     立方体";
        chooseregions[2].typename="   正八面体";
        chooseregions[3].typename="正十二面体";
        chooseregions[4].typename="正二十面体";
    }
...
//       shadowpaint.setPathEffect(createPathEffect(shadowlength, shadowprogress, 0.0f));
    ...
    Bitmap c1 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section7_page4_img1)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section7_page4_img1)).getBitmap() : null;
    Bitmap c2 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section7_page4_img2)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section7_page4_img2)).getBitmap() : null;
    Bitmap c3 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section7_page4_img3)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section7_page4_img3)).getBitmap() : null;
    Bitmap c4 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section7_page4_img4)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section7_page4_img4)).getBitmap() : null;
    Bitmap c5 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book3_section7_page4_img5)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book3_section7_page4_img5)).getBitmap() : null;
    public void onDraw(Canvas c) {
        ...
        for(int i=0;i<minrects.length;i++){
            c.drawRect(minrects[i],paint);
        }
        paint.setStyle(Paint.Style.FILL);
        for(int i=0;i<regions.length;i++){
            paint.setTextSize(30 * fontrite);
            if(regions[i].isright) {
                c.drawText( regions[i].typename, regions[i].point_x - 6 * onep_screen_w, regions[i].point_y + 1* onep_screen_w, paint);
            }
        }
        //选择区域
        if(isshadow) {
            for (int i = 0; i < chooseregions.length; i++) {
                paint.setTextSize(30 * fontrite);
                c.drawText(chooseregions[i].typename, chooseregions[i].point_x - 6*onep_screen_w, chooseregions[i].point_y + 1 * onep_screen_w, paint);
            }
        }
        //勾叉
        if(isright){
