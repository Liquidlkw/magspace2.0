...
public class SimilarPic1choosepic extends View {
    Path path,anopath;
    Paint paint;
    ...
    public static SimilarPic1choosepic instance;
    public static  SimilarPic1choosepic getInstance(Context context, Display display){
        if (instance == null) {
            instance=new SimilarPic1choosepic(context, display);
        }
        return instance;
    }
    public SimilarPic1choosepic(Context context) {
        super(context);
    }
    public SimilarPic1choosepic(Context context,Display display) {
        super(context);
        this.init(display);
    }
...
//                regions[i] = new Touchregion(path);
            if(i<4) {
                ...
                if(i==0){
                    ...
                    ObjectAnimator animator = ObjectAnimator.ofFloat(SimilarPic1choosepic.this, "progress1", 0.0f, 1.0f);
                ...
                if(i==1){
                    ...
                    ObjectAnimator animator = ObjectAnimator.ofFloat(SimilarPic1choosepic.this, "progress2", 0.0f, 1.0f);
                    animator.setDuration(1000);
                ...
                if(i==2){
                    ...
                    ObjectAnimator animator = ObjectAnimator.ofFloat(SimilarPic1choosepic.this, "progress3", 0.0f, 1.0f);
                    animator.setDuration(1000);
                ...
                if(i==3){
                    ...
                    ObjectAnimator animator = ObjectAnimator.ofFloat(SimilarPic1choosepic.this, "progress4", 0.0f, 1.0f);
                    animator.setDuration(1000);
        ...
        regions[0].typename=regions[7].typename="fang";
        regions[1].typename=regions[6].typename="jia";
        regions[2].typename=regions[4].typename="chang";
        regions[3].typename=regions[5].typename="xin";
    }
    ...
    Bitmap c1 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img1)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img1)).getBitmap() : null;
    Bitmap c2 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img2)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img2)).getBitmap() : null;
    Bitmap c3 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img3)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img3)).getBitmap() : null;
    Bitmap c4 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img4)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img4)).getBitmap() : null;
    Bitmap c5 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img5)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img5)).getBitmap() : null;
    Bitmap c6 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img6)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img6)).getBitmap() : null;
    Bitmap c7 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img7)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img7)).getBitmap() : null;
    Bitmap c8 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.book2_section1_page1_img8)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.book2_section1_page1_img8)).getBitmap() : null;
