...
public class Dice6 extends BasePageActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setcontentlayout(R.layout.activity_dice6);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            default:
                break;
            case R.id.row1:
                DataUtil.correct(mRow1,R.drawable.book2_section4_page6_img1_right);
                break;
            case R.id.row2:
                DataUtil.error(mRow2);
                break;
            case R.id.row3:
                DataUtil.error(mRow3);
                break;
            case R.id.row4:
                DataUtil.error(mRow2);
                break;
            case R.id.row5:
                DataUtil.correct(mRow5,R.drawable.book2_section4_page6_img5_right);
                break;
            case R.id.row6:
                DataUtil.correct(mRow6,R.drawable.book2_section4_page6_img6_right);
                break;
        }
    }
}
