...
public class ThreeDgame5 extends ThreeDgameFather {
    public static ThreeDgame5 instance;

    public static  ThreeDgame5 getInstance(Context context, Display display){
        if (instance == null) {
            instance=new ThreeDgame5(context, display);
        }
        return instance;
    }

    public ThreeDgame5(Context context,Display display) {
        super(context);
        this.init(display);
    }
    public void init(Display display) {
        super.init(display);
        rightcheckanimator = ObjectAnimator.ofFloat(ThreeDgame5.this, "rightcheckprogress", 0.0f, 1.0f);
        rightcheckanimator.setDuration(750);
        checkanimator = ObjectAnimator.ofFloat(ThreeDgame5.this, "checkprogress", 0.0f, 1.0f);
    ...
    Bitmap Back = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page6img)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page6img)).getBitmap() : null;
    Bitmap choose1 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page6choose1)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page6choose1)).getBitmap() : null;
    Bitmap choose2 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page6choose2)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page6choose2)).getBitmap() : null;
    Bitmap choose3 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page6choose3)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page6choose3)).getBitmap() : null;
    Bitmap choose4 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page6choose4)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page6choose4)).getBitmap() : null;
