...
public class ThreeDgame4 extends ThreeDgameFather {
    public static ThreeDgame4 instance;

    public static  ThreeDgame4 getInstance(Context context, Display display){
        if (instance == null) {
            instance=new ThreeDgame4(context, display);
        }
        return instance;
    }

    public ThreeDgame4(Context context,Display display) {
        super(context);
        this.init(display);
    }
    public void init(Display display) {
        super.init(display);
        rightcheckanimator = ObjectAnimator.ofFloat(ThreeDgame4.this, "rightcheckprogress", 0.0f, 1.0f);
        rightcheckanimator.setDuration(750);
        checkanimator = ObjectAnimator.ofFloat(ThreeDgame4.this, "checkprogress", 0.0f, 1.0f);
    ...
    Bitmap Back = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page5img)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page5img)).getBitmap() : null;
    Bitmap choose1 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page5choose1)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page5choose1)).getBitmap() : null;
    Bitmap choose2 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page5choose2)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page5choose2)).getBitmap() : null;
    Bitmap choose3 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page5choose3)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page5choose3)).getBitmap() : null;
    Bitmap choose4 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page5choose4)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page5choose4)).getBitmap() : null;
