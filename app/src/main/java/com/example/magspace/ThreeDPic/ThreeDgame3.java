...
public class ThreeDgame3 extends ThreeDgameFather {
    public static ThreeDgame3 instance;

    public static  ThreeDgame3 getInstance(Context context, Display display){
        if (instance == null) {
            instance=new ThreeDgame3(context, display);
        }
        return instance;
    }

    public ThreeDgame3(Context context,Display display) {
        super(context);
        this.init(display);
    }
    public void init(Display display) {
        super.init(display);
        rightcheckanimator = ObjectAnimator.ofFloat(ThreeDgame3.this, "rightcheckprogress", 0.0f, 1.0f);
        rightcheckanimator.setDuration(750);
        checkanimator = ObjectAnimator.ofFloat(ThreeDgame3.this, "checkprogress", 0.0f, 1.0f);
    ...
    Bitmap Back = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page4img)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page4img)).getBitmap() : null;
    Bitmap choose1 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page4choose1)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page4choose1)).getBitmap() : null;
    Bitmap choose2 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page4choose2)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page4choose2)).getBitmap() : null;
    Bitmap choose3 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page4choose3)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page4choose3)).getBitmap() : null;
    Bitmap choose4 = ((BitmapDrawable) this.getResources().getDrawable(R.drawable.s5page4choose4)) != null ? ((BitmapDrawable)
            this.getResources().getDrawable(R.drawable.s5page4choose4)).getBitmap() : null;
